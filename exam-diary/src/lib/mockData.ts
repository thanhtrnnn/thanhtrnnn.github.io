...
export function initQuizanoData() {
...
export function saveData(key: string, dataArray: any[]) {
...
export function getCurrentUser() {
    const user = localStorage.getItem('quizano_currentUser');
...
export function setLogin(user: any) {
    localStorage.setItem('quizano_currentUser', JSON.stringify(user));
}
